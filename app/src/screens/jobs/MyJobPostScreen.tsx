...
import RecruiterViewPostCard from '../../components/posts/RecruiterViewPostCard';

const noOfSkeleton = [1, 2, 3]

const MyJobPostScreen = ({ navigation }) => {
    ...
    const getJobsData = async () => {
        try {
            await axios.get(`${API_URL}/api/users/get-my-jobpost`, {
                headers: {
                ...
                isLoading ?
                    ...
                    jobs && jobs.length > 0 ?
                        <Animated.FlatList
                            ...
                            renderItem={({ item }) => <RecruiterViewPostCard item={item} screen={'MyApplications'} resume={user?.resume || null} />}
                            scrollEventThrottle={1}
...
export default MyJobPostScreen
